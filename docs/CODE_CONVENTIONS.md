...
* **Rotas e Diretórios:** `kebab-case` para pastas em `src/app` (ex: `criar-equipe`, `montagem-equipe`, `sala-de-equipe`, `resumo-fase`, `provas-antigas`, `tarefas/migalhas-flavio-tavares`, `tarefas/viagem-no-tempo`, `tarefas/charadas`).
