      ...
      <div className='w-full min-h-screen bg-[#fff] text-[#000] flex flex-col'>
        ...
        <main className='flex-1' style={{ backgroundImage: 'url(/bg-dhpb.svg)' }}>
          <section className='max-w-7xl mx-auto py-16 px-6'>
            <h1 className='text-[#fff] font-bold text-4xl md:text-5xl lg:text-6xl'>Contato</h1>
            <p className='text-lg md:text-xl text-white mt-4 max-w-2xl'>Teve algum problema? Entre em contato conosco!</p>
            ...
            <div className='mt-10 space-y-6'>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <p className='text-xl font-semibold text-white'>+55 83 98195-3325</p>
                </div>
              </div>

              <div className='flex items-center gap-4'>
                <div className='text-white/70'>
                  <svg width="35" height="35" fill="currentColor" viewBox="0 0 16 16"><path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/></svg>
                </div>
                <div>
                  <p className='text-xl font-semibold text-white'>dhpb@ifpb.edu.br</p>
                </div>
              </div>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <p className='text-xl font-semibold text-white'>@oficialdhpb</p>
                </div>
              </div>
            </div>
          </section>
