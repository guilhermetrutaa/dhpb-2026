  ...
  return (
    <div className={poppins.className}>
      <div className='w-full min-h-screen bg-[#fff] text-[#000]'>
        ...
        <main className='px-6 md:px-12 lg:pl-25 pt-15'>
          <div>
            <h1 className='text-3xl md:text-5xl lg:text-[3rem] font-bold text-[#82181A] max-w-[50rem] leading-tight'>
              Seja Bem-Vindo(a) ao 4° Desafio em História da Paraíba
            </h1>
          </div>

          <div className='pt-4'>
            <p className='text-lg md:text-xl lg:text-[1.3rem] max-w-[60rem]'>
              O DHPB (Desafio em História da Paraíba) é uma iniciativa do IFPB com o objetivo de promover conhecimento sobre a história e cultura da nossa região.
            </p>
          </div>
          ...
          <div className='flex flex-wrap items-center gap-3 pt-8'>
            {authUser ? (
              <button
                onClick={handleGoToHome}
                className='bg-[#82181A] text-[#fff] text-[1.1rem] w-full sm:w-[10rem] h-[3rem] cursor-pointer'
              >
                Ir para home
              </button>
            ) : (
              <button className='bg-[#82181A] text-[#fff] text-[1.1rem] w-full sm:w-[10rem] h-[3rem] cursor-pointer'>
                <a href="/login">Inscreva-se</a>
              </button>
            )}
            <button className='border-[#82181A] border-[3px] text-[#82181A] text-[1.1rem] font-medium w-full sm:w-[10rem] h-[3rem] cursor-pointer'>
          ...
          <div className='pt-12 md:pt-20'>
            <div className="relative w-full max-w-[1320px]">
              <Image
                ...
                height={400}
                alt="Banner Nego"
                className='rounded-[10px] shadow-xl w-full h-auto object-cover'
              />
            </div>
          </div>
        </main>

        <footer className="w-full pt-12 md:pt-20 pb-10">
