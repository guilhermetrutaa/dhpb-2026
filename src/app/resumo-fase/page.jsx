...
function ResumoFaseContent() {
  ...
  const tarefaDaFase = respostas[`tarefa_${faseId}`]
    ?? (String(respostas.tarefa?.faseId || '') === String(faseId || '') ? respostas.tarefa : null)
  const tarefaStatus = tarefaDaFase?.status || 'pendente'
