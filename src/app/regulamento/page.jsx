      ...
      <div className='w-full min-h-screen bg-[#fff] text-[#000] flex flex-col'>
        ...
        <main className='flex-1' style={{ backgroundImage: 'url(/bg-dhpb.svg)' }}>
          <section className='max-w-4xl mx-auto py-16 px-6'>
            <h1 className='text-white font-bold text-4xl md:text-5xl pb-6'>Regulamento</h1>
            <div className='bg-black/50 p-6 md:p-8 rounded-xl text-white/90 text-sm leading-relaxed space-y-4'>
              <h2 className='text-xl font-bold text-white'>DHPB 2026 — EDITAL</h2>
              <p>A Comissão Organizadora do Desafio em História da Paraíba, instituída pelo Instituto Federal de Educação, Ciência e Tecnologia da Paraíba — IFPB, no uso de suas atribuições, torna pública a abertura de inscrições para o Desafio em História da Paraíba, de acordo com as disposições estipuladas neste Edital.</p>

              <h3 className='text-lg font-bold text-white'>1. DO OBJETO</h3>
              <p>O DHPB é uma Olimpíada de Conhecimento voltada ao incentivo í  pesquisa com finalidade educacional e cultural, organizada pelo IFPB, que será desenvolvida de forma híbrida, composta por fases online e uma fase final presencial.</p>

              <h3 className='text-lg font-bold text-white'>2. DOS OBJETIVOS</h3>
              <p>Estimular a formação integral de jovens e adultos paraibanos por meio da pesquisa e utilização de Tecnologias Digitais de Informação e Comunicação, contribuindo para o conhecimento da realidade e o desenvolvimento da cidadania.</p>

              <h3 className='text-lg font-bold text-white'>3. DA PARTICIPAÇÃO</h3>
              <p>Poderão participar estudantes regularmente matriculados a partir do 8Â° ano do Ensino Fundamental até o último ano do Ensino Médio, bem como alunos da EJA, de escolas públicas e privadas de todo o Estado da Paraíba.</p>

              <h3 className='text-lg font-bold text-white'>4. DAS FASES</h3>
              <p>O DHPB será composto por 4 (quatro) fases online e 1 (uma) fase final presencial. Cada fase é classificatória e eliminatória, e os pontos obtidos são cumulativos para as fases seguintes.</p>

              <h3 className='text-lg font-bold text-white'>5. DA PREMIAÇÃO</h3>
              <p>Serão emitidos certificados de participação a todos os membros das equipes. As melhores equipes receberão medalhas de Ouro (1ª a 10ª), Prata (11ª a 25ª), Bronze (26ª a 50ª) e Menção Honrosa (51ª a 120ª).</p>

              <h3 className='text-lg font-bold text-white'>6. DAS DISPOSIÇÕES FINAIS</h3>
              <p>Os casos omissos serão analisados pela Comissão Organizadora. Dúvidas sobre o Regulamento podem ser enviadas para: dhpb@ifpb.edu.br</p>

              <p className='pt-4 text-white font-bold text-center'>Comissão Organizadora do Desafio em História da Paraíba</p>
            </div>
          </section>
        </main>
