  ...
  return (
    <div className={poppins.className}>
      ...
      <section className='max-w-4xl mx-auto py-16 px-6'>
        <div className='bg-black/80 p-6 md:p-10 rounded-xl text-white/90 text-sm md:text-base leading-relaxed space-y-6 text-justify'>
          ...
          <div>
            ...
            <p className='font-semibold text-white text-justify'>O 4º DHPB conta com o apoio das seguintes instituições:</p>
            <ul className='list-disc list-inside space-y-1 mt-2 text-white/80 text-justify'>
          ...
          <div>
            ...
            <ul className='list-disc list-inside space-y-2 mt-2 text-white/80 text-justify'>
          ...
          <div>
            ...
            <ul className='list-disc list-inside space-y-1 text-white/80 text-justify'>
          ...
          <div>
            ...
            <p className='text-justify'>São requisitos para inscrição e participação no 4º DHPB os dispostos nos capítulos 2 e 3 deste edital.</p>
          </div>

          <div>
            <h3 className='text-lg font-bold text-white mb-2'>5. DAS FASES DO 4º DHPB</h3>
            <ul className='list-disc list-inside space-y-2 text-white/80 text-justify'>
              ...
              <p>5.4) A primeira fase online será formada por até 8 (oito) questões objetivas, compostas por 4 (quatro) itens cada, cuja pontuação atribuída a cada item pode ser 0 (zero), 2,00 (dois), 8,00 (oito) ou 10,00 (dez) pontos, e uma tarefa elaborada pela comissão organizadora do 4º DHPB equivalente a 20% (vinte por cento) da nota da fase (máximo de 20,00 pontos). A nota máxima da fase é 100,00 pontos (80,00 nas questões + 20,00 na tarefa). Não há teto de vagas. Serão eliminadas nesta fase as equipes participantes que não tenham atingido o perfil mínimo de obtenção de 25% (vinte e cinco por cento) dos pontos da fase, ou seja, nota bruta mínima de 25,00 pontos, e/ou mediante nota de corte da etapa estabelecida pela Comissão Organizadora.</p>
              <p>5.5) A segunda fase online será formada por até 8 (oito) questões objetivas, compostas por 4 (quatro) itens cada, cuja pontuação atribuída a cada item pode ser 0 (zero), 2,00 (dois), 8,00 (oito) ou 10,00 (dez) pontos, e uma tarefa elaborada pela comissão organizadora do 4º DHPB equivalente a 20% (vinte por cento) da nota da fase (máximo de 20,00 pontos). A nota máxima da fase é 100,00 pontos. Não há teto de vagas. Serão eliminadas nesta fase as equipes participantes que não tenham atingido o perfil mínimo de obtenção de 50% (cinquenta por cento) dos pontos da fase, ou seja, nota bruta mínima de 50,00 pontos, e/ou mediante nota de corte da fase estabelecida pela Comissão Organizadora.</p>
              <p>5.6) A terceira fase online será formada por até 8 (oito) questões objetivas, compostas por 4 (quatro) itens cada, cuja pontuação atribuída a cada item pode ser 0 (zero), 2,00 (dois), 8,00 (oito) ou 10,00 (dez) pontos, e uma tarefa elaborada pela comissão organizadora do 4º DHPB equivalente a 20% (vinte por cento) da nota da fase (máximo de 20,00 pontos). Na terceira fase, serão aprovadas no máximo 250 equipes, sendo 125 (cento e vinte e cinco) por ampla concorrência no ranking geral acumulado (Df) e 125 (cento e vinte e cinco) reservadas às melhores equipes subsequentes da rede pública (este número pode ser alterado exclusivamente a partir da deliberação da Comissão Organizadora; em caso de alteração, para mais ou para menos, a Comissão Organizadora registrará em "Comunicado Oficial" o novo limite de equipes que participarão da fase seguinte). O número de equipes aprovadas na fase 4 não é ou será relacionado à uma proporção do número de equipes inscritas, mas sim à deliberação da Comissão Organizadora que levará em conta exclusivamente a operacionalidade da tarefa da fase 4 e sua correção e/ou mediante nota de corte da fase estabelecida pela Comissão Organizadora.</p>
              ...
              <p>5.14) A quantidade de equipes participantes da fase final presencial do 4º DHPB será de até 120 (cento e vinte) equipes, dentre as que obtiverem maior pontuação acumulada nas fases anteriores (Df), em ordem de classificação. 50% destas vagas (60) serão destinadas para equipes oriundas da rede pública estadual, municipal ou federal. O preenchimento observa: as primeiras 60 vagas pelo ranking geral (ampla concorrência); se nessas 60 houver menos de 60 equipes públicas, as vagas da reserva são preenchidas pelas melhores equipes públicas subsequentes até cravar o mínimo de 60 públicas; o restante das vagas é completado na sequência do ranking geral. Persistindo empate na linha de corte após os critérios do item 6.4, as equipes empatadas avançam em conjunto.</p>
              ...
              <p>5.15) Ficam alertado(a)s o(a)s participantes da fase final, de que deverão providenciar uma série de documentos relativos à viagem para Patos e outros documentos relativos à participação na Fase Final.</p>
              ...
              <p>5.19) As fases do 4º DHPB terão pesos diferentes e crescentes, correspondendo respectivamente aos pesos de 1 (um), 2 (dois), 4 (quatro), 8 (oito) e 16 (dezesseis) para cada uma das 5 (cinco) fases. O desempenho de cada fase (Di) é a nota bruta da fase (0 a 100) multiplicada pelo peso da fase. O desempenho final (Df) é a soma dos desempenhos, com valor máximo de 3.100 pontos.</p>
            </ul>
          </div>
