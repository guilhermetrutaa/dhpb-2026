...
export default function Page() {
  ...
  const livros = [
    { img: '/previa-livros/previa-livro1.svg', titulo: 'História da Paraíba — Livro 1', desc: 'Colonização, cultura, modernização e desafios sociais.', url: 'https://drive.google.com/file/d/1_sM_rOPsm8zJjbGu4swOptTP6MJC20Xk/view' },
    { img: '/previa-livros/previa-livro2.svg', titulo: 'História da Paraíba — Livro 2', desc: 'Colonização, governo colonial, ordens religiosas, população indígena, invasões holandesas.', url: 'https://drive.google.com/file/d/1o7NcZxXwSihFbY-rOtgEk3YlAMgYCTDW/view' },
    { img: '/previa-livros/previa-livro3.svg', titulo: 'História da Paraíba — Livro 3', desc: 'Origens, invasões holandesas, integração territorial, oligarquias, crise social.', url: 'https://drive.google.com/file/d/1dlsgvW_ugbxy4tFgDb6x5QEF9CuNRWo5/view' },
    { img: '/previa-livros/previa-livro4.svg', titulo: 'História da Paraíba — Livro 4', desc: 'Chegada dos europeus, pré-história, resistência indígena, escravidão, domínio holandês.', url: 'https://drive.google.com/file/d/1zyb5f1-dmzJNMcXP51FGV7W9du2LoOj-/view' },
    { img: '/previa-livros/previa-livro5.svg', titulo: 'História da Paraíba — Livro 5', desc: 'Conquista, fundação, holandeses, revoltas, República, Governo de João Pessoa.', url: 'https://drive.google.com/file/d/18VxHo35TRLC44G9v1kPHr2SijN6Ao0M9/view' },
  ]
  ...
  return (
    <div className={poppins.className}>
      <div className='w-full min-h-screen bg-[#fff] text-[#000] flex flex-col'>
        ...
        <main style={{ backgroundImage: 'url(/bg-dhpb.svg)' }} className='flex-1'>
          <section className='max-w-7xl mx-auto py-16 px-6'>
            <h1 className='text-[#FFF] font-bold text-4xl md:text-5xl'>Biblioteca</h1>
            <p className='text-[#fff] text-lg mt-4 max-w-2xl'>Materiais de estudo, apostilas e conteúdos exclusivos para auxiliar na sua preparação para o DHPB.</p>

            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-10'>
              {livros.map((livro, i) => (
                <a key={i} href={livro.url} target="_blank" rel="noopener noreferrer" className='group'>
                  <div className='bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all'>
                    <img src={livro.img} alt={livro.titulo} className='w-full h-120 object-cover group-hover:scale-105 transition-transform' />
                    <div className='p-4'>
                      <h2 className='font-bold text-lg text-[#82181A]'>{livro.titulo}</h2>
                      <p className='text-sm text-neutral-500 mt-1'>{livro.desc}</p>
                    </div>
                  </div>
                </a>
              ))}
